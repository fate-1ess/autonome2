        ...
        {loading ? (
          ...
          <div>
            {trades.map((trade, idx) => {
              const modelInfo = getModelInfo(trade.modelKey || trade.modelName);
              const modelColor = modelInfo.color || "#888888";
              const modelLabel =
                modelInfo.logo
                  ? modelInfo.label
                  : trade.modelName || trade.modelRouterName || trade.modelKey || "Unknown Model";
              ...
              const entryNotionalLabel =
                trade.entryNotional != null ? formatCurrency(trade.entryNotional) : "--";
              const exitNotionalLabel =
                trade.exitNotional != null ? formatCurrency(trade.exitNotional) : "--";
              ...
              return (
                <div key={trade.id}>
                  ...
                  {idx < trades.length - 1 && <div className="mx-4 border-b" />}
                </div>
              );
            })}
          </div>
