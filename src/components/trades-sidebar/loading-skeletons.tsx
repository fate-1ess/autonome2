  ...
  return (
    <div className="space-y-4 p-4">
      {Array.from({ length: count }).map((_, index) => (
        <div key={index} className="rounded-md border border-border/60 bg-muted/20 p-4">
...
export function ModelChatSkeleton({ count = 3 }: { count?: number }) {
  return (
    <div className="space-y-4 p-4">
      {Array.from({ length: count }).map((_, index) => (
        <div key={index} className="rounded-md border border-border/60 bg-muted/15 p-4">
...
export function PositionsListSkeleton({ groups = 2, rows = 3 }: { groups?: number; rows?: number }) {
  return (
    <div className="space-y-4 p-4">
      {Array.from({ length: groups }).map((_, groupIdx) => (
        <div key={groupIdx} className="rounded-md border border-border/60 bg-muted/15">
