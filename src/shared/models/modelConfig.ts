export const MODEL_INFO: Record<string, { logo: string; color: string; label: string }> = {
...
export function getModelInfo(modelName: string): { logo: string; color: string; label: string } {
