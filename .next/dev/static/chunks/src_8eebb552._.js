...
const CustomEndDot = (t0)=>{
    ...
    if ($[0] !== "e43e3b1a72b5555f4192acdec5dc892bb8ed2e5770a42e890df2e7f8983be1aa") {
        for(let $i = 0; $i < 37; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "e43e3b1a72b5555f4192acdec5dc892bb8ed2e5770a42e890df2e7f8983be1aa";
    }
    const { cx, cy, value, dataKey, index, data, hoveredLine, seriesMeta, valueMode } = t0;
    if (typeof cx !== "number" || typeof cy !== "number" || !Array.isArray(data) || typeof index !== "number" || index !== data.length - 1 || typeof value !== "number" || !Number.isFinite(value)) {
        return null;
    }
    ...
    let t1;
    if ($[1] !== originalKey) {
        t1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$modelConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModelInfo"])(originalKey);
        $[1] = originalKey;
        $[2] = t1;
    } else {
        t1 = $[2];
    ...
    let t5;
    if ($[6] !== color || $[7] !== cx || $[8] !== cy || $[9] !== t3 || $[10] !== t4) {
    ...
    let t13;
    if ($[14] !== logo || $[15] !== t11 || $[16] !== t12 || $[17] !== t6 || $[18] !== t7 || $[19] !== t8 || $[20] !== t9) {
    ...
    let t20;
    if ($[28] !== t14 || $[29] !== t15 || $[30] !== t16 || $[31] !== t19) {
...
function GlowingLineChart(t0) {
    ...
    if ($[3] !== seriesMeta || $[4] !== t3) {
        t4 = t3.filter({
            "GlowingLineChart[(anonymous)()]": (key)=>{
                const originalKey = seriesMeta[key]?.originalKey ?? key;
                return originalKey !== "buynnhold_btc";
            }
    ...
    if ($[6] !== modelKeys || $[7] !== seriesMeta) {
        t5 = ({
            "GlowingLineChart[useEffect()]": ()=>{
                ...
                }["GlowingLineChart[useEffect() > modelKeys.map()]"]).filter(Boolean);
                logos.forEach(_GlowingLineChartUseEffectLogosForEach);
            }
        })["GlowingLineChart[useEffect()]"];
        t6 = [
            modelKeys,
    ...
    bb0: {
        ...
        const originalKey_0 = seriesMeta[hoveredLine]?.originalKey ?? hoveredLine;
        let t10;
        if ($[15] !== originalKey_0) {
            t10 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$modelConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModelInfo"])(originalKey_0);
            $[15] = originalKey_0;
            $[16] = t10;
        } else {
            t10 = $[16];
        ...
        t38 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("defs", {
            children: modelKeys.map({
                "GlowingLineChart[modelKeys.map()]": (key_2)=>{
                    const originalKey_1 = seriesMeta[key_2]?.originalKey ?? key_2;
                    const modelInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$modelConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModelInfo"])(originalKey_1);
    ...
    let t48;
    if ($[90] !== chartConfig || $[91] !== hoveredLine || $[92] !== modelKeys || $[93] !== seriesMeta || $[94] !== setHoveredLine || $[95] !== valueMode) {
        t48 = modelKeys.map({
            "GlowingLineChart[modelKeys.map()]": (key_3)=>{
                const originalKey_2 = seriesMeta[key_3]?.originalKey ?? key_3;
                const modelInfo_0 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$modelConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModelInfo"])(originalKey_2);
    ...
    let t49;
    if ($[97] !== chartData || $[98] !== t36 || $[99] !== t38 || $[100] !== t40 || $[101] !== t44 || $[102] !== t45 || $[103] !== t47 || $[104] !== t48) {
...
function _GlowingLineChartUseEffectLogosForEach(url) {
...
function ModelLegend(t0) {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(15);
    if ($[0] !== "bd28db9214ad468b101db8b17f6f220353e5f58f0fdf82a3196d73fef1866ecd") {
        for(let $i = 0; $i < 15; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "bd28db9214ad468b101db8b17f6f220353e5f58f0fdf82a3196d73fef1866ecd";
    }
    ...
    const t9 = sortedModelKeys.map({
        "ModelLegend[sortedModelKeys.map()]": (key_1)=>{
            const originalKey_0 = seriesMeta[key_1]?.originalKey ?? key_1;
...
function TradesSidebar(t0) {
    ...
    if ($[0] !== "239a1e6d5dc6da8a245204d635c0a3771272b896a23278fd94c5e3d9ea7b2f7d") {
        for(let $i = 0; $i < 57; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "239a1e6d5dc6da8a245204d635c0a3771272b896a23278fd94c5e3d9ea7b2f7d";
    }
    const { isExpanded } = t0;
    ...
    let t5;
    if ($[21] !== filter || $[22] !== isInitialLoading || $[23] !== modelOptions || $[24] !== selectedModelLabel) {
        t5 = ({
    ...
    let t11;
    if ($[31] !== activeTab || $[32] !== filteredTrades || $[33] !== loading || $[34] !== renderFilterMenu) {
    ...
    let t12;
    if ($[36] !== activeTab || $[37] !== filteredConversations || $[38] !== loading || $[39] !== renderFilterMenu) {
    ...
    let t13;
    if ($[41] !== activeTab || $[42] !== filteredPositions || $[43] !== loading || $[44] !== renderFilterMenu) {
    ...
    let t16;
    if ($[49] !== t10 || $[50] !== t11 || $[51] !== t12 || $[52] !== t13 || $[53] !== t15 || $[54] !== t6 || $[55] !== t9) {
...
//# sourceMappingURL=src_8eebb552._.js.map