...
function CryptoTracker() {
    ...
    const { data: sanitizedPrices } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$usePollingFetch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePollingFetch"])(`/api/crypto-prices?symbols=${TRACKED_SYMBOLS.join(",")}`, {
...
_s(CryptoTracker, "J6l94h+GsFHkXT8zSHDFHIfcILw=", false, function() {
    return [
...
function PriceWithDiff(t0) {
    ...
    if ($[0] !== "39ed27f2ba5a7a65d8cae0fffe5f5b3903364a53c8caba3b88852b8c331eec6a") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "39ed27f2ba5a7a65d8cae0fffe5f5b3903364a53c8caba3b88852b8c331eec6a";
    }
...
function Header(t0) {
    ...
    if ($[0] !== "61e04c16c71baa120a414f3f8d03698923a6abf530d0522fe6cace3b31f4d810") {
        for(let $i = 0; $i < 11; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "61e04c16c71baa120a414f3f8d03698923a6abf530d0522fe6cace3b31f4d810";
    }
...
function ModelLegend(t0) {
    ...
    if ($[0] !== "1ba71b5e946d85eb82d0a211f945799240360567b1938b8d0b85f29b063b2915") {
        for(let $i = 0; $i < 10; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "1ba71b5e946d85eb82d0a211f945799240360567b1938b8d0b85f29b063b2915";
    }
...
function PerformanceGraph() {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(28);
    if ($[0] !== "dc06fba07da57198b70544b16e0931d3554c88e508d607cec3c0fe482010c66e") {
        for(let $i = 0; $i < 28; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "dc06fba07da57198b70544b16e0931d3554c88e508d607cec3c0fe482010c66e";
    }
    ...
    const { chartData, chartConfig } = t1;
    let t2;
    if ($[5] !== chartData || $[6] !== timeFilter) {
    ...
    let t3;
    if ($[8] !== chartConfig || $[9] !== filteredData || $[10] !== valueMode) {
        t3 = valueMode === "usd" ? filteredData : toPercentData(filteredData, chartConfig);
        $[8] = chartConfig;
        $[9] = filteredData;
        $[10] = valueMode;
        $[11] = t3;
    ...
    let t4;
    if ($[14] !== chartConfig || $[15] !== displayData || $[16] !== hoveredLine || $[17] !== timeFilter || $[18] !== valueMode) {
        t4 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    let t5;
    if ($[20] !== chartConfig || $[21] !== displayData || $[22] !== hoveredLine || $[23] !== valueMode) {
...
function ExitPlanDialog(t0) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(9);
    if ($[0] !== "47aa46f87ed0df2380182d60ebde9f6dfd79d2b08a1cd926c2b882eeae63a7fe") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "47aa46f87ed0df2380182d60ebde9f6dfd79d2b08a1cd926c2b882eeae63a7fe";
    }
...
function ModelChatTab(t0) {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(13);
    if ($[0] !== "c3e8d9752b9868272bb9eaf9b2c5d6e153ec22354788606d7ecd219a96eba021") {
        for(let $i = 0; $i < 13; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "c3e8d9752b9868272bb9eaf9b2c5d6e153ec22354788606d7ecd219a96eba021";
    }
...
function ModelFilterMenu(t0) {
    ...
    if ($[0] !== "ef5de589998059b366ed8686717f90c06640cfb15d53cbbf757eb30464c2464a") {
        for(let $i = 0; $i < 23; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "ef5de589998059b366ed8686717f90c06640cfb15d53cbbf757eb30464c2464a";
    }
    const { selectedLabel, onFilterChange, options, metaLabel } = t0;
    let t1;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
    ...
    let t5;
    if ($[7] !== onFilterChange || $[8] !== options) {
        let t6;
        if ($[10] !== onFilterChange) {
            t6 = ({
    ...
    let t8;
    if ($[18] !== metaLabel) {
        t8 = metaLabel ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
function PositionsTab(t0) {
    ...
    if ($[0] !== "7d61ce6d32e258ef08b2b94e55d2a43156062cc3fe3c96f887ec7d8b154b076b") {
        for(let $i = 0; $i < 8; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "7d61ce6d32e258ef08b2b94e55d2a43156062cc3fe3c96f887ec7d8b154b076b";
    }
...
function SidebarTabs(t0) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(6);
    if ($[0] !== "c0b07af8438e0ca0443c892f2291e7f92b6cf7776b73de22553c092b2b87fe41") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "c0b07af8438e0ca0443c892f2291e7f92b6cf7776b73de22553c092b2b87fe41";
    }
...
function TradesTab(t0) {
    ...
    if ($[0] !== "1910394d739750d4c8968c45ea4c2a9c07453795db6608aa0705a2abc6aa828a") {
        for(let $i = 0; $i < 7; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "1910394d739750d4c8968c45ea4c2a9c07453795db6608aa0705a2abc6aa828a";
    }
...
function TradesSidebar(t0) {
    ...
    if ($[0] !== "f2356b5a7e5b010f33ab878ae98452d120a4467a9dd68bb22f0d73aa7f1798a6") {
        for(let $i = 0; $i < 56; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "f2356b5a7e5b010f33ab878ae98452d120a4467a9dd68bb22f0d73aa7f1798a6";
    }
    const { isExpanded } = t0;
    ...
    const filteredConversations = t2;
    let t3;
    bb2: {
        if (filter === "all") {
            t3 = positions;
    ...
    let t4;
    if ($[18] !== filter || $[19] !== modelOptionsLookup) {
        t4 = filter === "all" ? "All Models" : modelOptionsLookup.get(filter)?.label ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$modelConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModelInfo"])(filter).label;
        $[18] = filter;
        $[19] = modelOptionsLookup;
        $[20] = t4;
    } else {
        t4 = $[20];
    }
    const selectedModelLabel = t4;
    let t5;
    if ($[21] !== filter || $[22] !== modelOptions || $[23] !== selectedModelLabel) {
        t5 = ({
        ...
        $[21] = filter;
        $[22] = modelOptions;
        $[23] = selectedModelLabel;
        $[24] = t5;
    } else {
        t5 = $[24];
    }
    const renderFilterMenu = t5;
    const t6 = `flex h-full flex-col border-l bg-background transition-all duration-1000 ease-[cubic-bezier(0.091,0.543,0.148,0.909)] ${isExpanded ? "w-full" : "w-96"}`;
    const t7 = isExpanded ? "absolute" : "relative";
    const t8 = isExpanded ? 50 : 1;
    let t9;
    if ($[25] !== t7 || $[26] !== t8) {
        t9 = {
            position: t7,
    ...
    let t16;
    if ($[48] !== t10 || $[49] !== t11 || $[50] !== t12 || $[51] !== t13 || $[52] !== t15 || $[53] !== t6 || $[54] !== t9) {
...
_s(TradesSidebar, "JbJpESYZRB50kS1vOozOug2fhEA=", false, function() {
    return [
...
function HomePage() {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(13);
    if ($[0] !== "96b4679230c557af9b839cccfbd6baca2b0308a2299ff9313e163e86bab6bf5f") {
        for(let $i = 0; $i < 13; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "96b4679230c557af9b839cccfbd6baca2b0308a2299ff9313e163e86bab6bf5f";
    }
    ...
    let t4;
    if ($[7] !== isSidebarExpanded || $[8] !== toggleSidebar) {
        t4 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=src_a1b3bf10._.js.map