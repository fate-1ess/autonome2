...
"[project]/src/app/api/portfolio-history/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"8081842ad5d2ff502a529ef3a48ede344674e77a9d":"$$RSC_SERVER_CACHE_0"},"",""] */ __turbopack_context__.s([
    "$$RSC_SERVER_CACHE_0",
    ()=>$$RSC_SERVER_CACHE_0,
    "GET",
    ()=>GET
...
;
;
var $$RSC_SERVER_CACHE_0 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$cache$2d$wrapper$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cache"])("default", "8081842ad5d2ff502a529ef3a48ede344674e77a9d", 0, async function loadPortfolioHistory() {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cacheTag"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cache$2f$tags$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DATA_CACHE_TAGS"].PORTFOLIO_HISTORY);
    ...
    const portfolioData = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].portfolioSize.findMany({
        include: {
            model: {
                select: {
                    name: true,
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])($$RSC_SERVER_CACHE_0, "8081842ad5d2ff502a529ef3a48ede344674e77a9d", null);
Object["defineProperty"]($$RSC_SERVER_CACHE_0, "name", {
    value: "loadPortfolioHistory",
    writable: false
});
var loadPortfolioHistory = $$RSC_SERVER_CACHE_0;
async function GET() {
    try {
        const portfolioHistory = await loadPortfolioHistory();
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(portfolioHistory);
    } catch (error) {
        console.error("Failed to fetch portfolio history:", error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: error instanceof Error ? error.message : "Unknown error while fetching portfolio history"
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f3b3b4ca._.js.map