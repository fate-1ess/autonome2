...
async function getOpenPositions(apiKey, accountIndex, accountId) {
    if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["IS_SIMULATION_ENABLED"]) {
        ...
        const availableCapital = accountSnapshot.availableCash ?? 0;
        return simulator.getOpenPositions(simulatorAccountId).map((position)=>{
            const quantity = position.quantity;
            const entryPrice = position.avgEntryPrice ?? null;
            const notionalEntry = entryPrice != null ? entryPrice * Math.abs(quantity) : position.markPrice != null ? position.markPrice * Math.abs(quantity) : null;
            const leverage = availableCapital > 0 && notionalEntry != null ? Math.min(10, notionalEntry / availableCapital) : undefined;
            return {
...
async function getPortfolio(account) {
    if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["IS_SIMULATION_ENABLED"]) {
        ...
        const usableCash = Math.min(snapshot.cashBalance, equityValue);
        const availableCash = Math.max(usableCash, 0);
        return {
...
async function GET() {
    try {
        ...
        const allPositions = await Promise.all(models.map(async (model)=>{
            try {
                const positions = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$openPositions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getOpenPositions"])(model.lighterApiKey, model.accountIndex, model.id);
                ...
                const decisionIndex = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$tradingDecisions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildDecisionIndex"])(toolCalls.map((tc)=>({
                        ...
                        metadata: (()=>{
                            try {
                                return JSON.parse(tc.metadata);
                            } catch (error) {
                                console.error("Failed to parse tool call metadata", error);
                                return null;
                            }
                        })()
                    })));
                const portfolio = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$getPortfolio$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getPortfolio"])({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f7fba9e1._.js.map